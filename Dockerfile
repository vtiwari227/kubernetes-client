...
RUN echo $PUBRING | base64 --decode > pubring.gpg
RUN echo $SEC_JENKINS |  base64 --decode > sec_jenkins.gpg
RUN echo $SECRING | base64 --decode > secring.gpg
RUN echo $TRUSTDB | base64 --decode > trustdb.gpg
